        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="property_category" id="property_category" required
                    ...
                    <option value="Residential" {{ old('property_category') === 'Residential' ? 'selected' : '' }}>Residential</option>
                    <option value="Commercial" {{ old('property_category') === 'Commercial' ? 'selected' : '' }}>Commercial</option>
                    <option value="Industrial" {{ old('property_category') === 'Industrial' ? 'selected' : '' }}>Industrial</option>
                    <option value="Land" {{ old('property_category') === 'Land' ? 'selected' : '' }}>Land</option>
                </select>
            ...
            <div>
                ...
                <select name="listing_type" id="listing_type" required
                    ...
                    <option value="For Rent" {{ old('listing_type') === 'For Rent' ? 'selected' : '' }}>For Rent</option>
                    <option value="For Lease" {{ old('listing_type') === 'For Lease' ? 'selected' : '' }}>For Lease</option>
                </select>
                @error('listing_type')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="price_currency" id="price_currency" required
                    ...
                    <option value="AUD" {{ old('price_currency') === 'AUD' ? 'selected' : '' }}>AUD</option>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="country" id="country" value="{{ old('country', 'Australia') }}"
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div>
                ...
                <input type="number" name="bathrooms" id="bathrooms" value="{{ old('bathrooms') }}" min="0" step="0.5"
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-6">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Upload a featured image for this property (max 2MB) - Preview will appear below when selected</p>
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Upload multiple images for the gallery (max 2MB each) - Preview will appear below when selected</p>
        ...
        featuredImageInput.addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    preview.innerHTML = `
                        <label class="block text-sm font-medium text-gray-700 mb-2">Featured Image Preview</label>
    ...
    if (galleryImagesInput) {
        galleryImagesInput.addEventListener('change', function(e) {
            ...
            if (files.length > 0) {
                ...
                preview.className = 'mt-2';
                preview.innerHTML = `
                    <label class="block text-sm font-medium text-gray-700 mb-2">Gallery Images Preview</label>
