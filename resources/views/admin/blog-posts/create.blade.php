...
<form method="POST" action="{{ route('admin.blog-posts.store') }}" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea name="excerpt" id="excerpt" rows="3" required
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary @error('excerpt') border-red-500 @enderror">{{ old('excerpt') }}</textarea>
            ...
            <div>
                ...
                <textarea name="content" id="content" rows="10" required
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary @error('content') border-red-500 @enderror">{{ old('content') }}</textarea>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <select name="category" id="category" required
                    ...
                    <option value="Property Investment" {{ old('category') == 'Property Investment' ? 'selected' : '' }}>Property Investment</option>
                    <option value="Market Trends" {{ old('category') == 'Market Trends' ? 'selected' : '' }}>Market Trends</option>
                    <option value="Real Estate News" {{ old('category') == 'Real Estate News' ? 'selected' : '' }}>Real Estate News</option>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Upload a featured image for this blog post (max 2MB) - Preview will appear below when selected</p>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea name="meta_description" id="meta_description" rows="3"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary @error('meta_description') border-red-500 @enderror">{{ old('meta_description') }}</textarea>
