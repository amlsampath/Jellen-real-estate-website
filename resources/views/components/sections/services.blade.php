...
<section id="services" class="services-section py-20 bg-white">
    <div class="container-custom">
        ...
        <div class="text-center mb-16">
            <div class="inline-flex items-center px-4 py-2 bg-accent/10 border-l-4 border-r-4 border-accent rounded-lg mb-6">
                <span class="text-sm font-semibold text-gray-800 uppercase">Our Services</span>
            </div>
            <h2 class="text-4xl font-bold text-gray-900 mb-6 leading-tight">
                Comprehensive Real Estate Solutions
            </h2>
            <p class="text-xl text-gray-600  mx-auto leading-relaxed">
                Whether you're buying, selling, or leasing, we provide expert guidance and support throughout your real estate journey.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Buying Service -->
            <div class="service-card bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 text-center group">
                <div class="flex justify-center mb-6">
                    <div class="w-20 h-20 bg-accent/10 rounded-2xl flex items-center justify-center group-hover:bg-accent/20 transition-colors duration-300">
                ...
                <a href="#" class="inline-flex items-center px-6 py-3 bg-accent text-white font-semibold rounded-lg hover:bg-accent-dark transition-all duration-300 transform hover:scale-105">
                    Learn More
